...
```
### Caractéristiques générales des surfaces en eau de plans d'eau 
...
Une analyse statistique du lien de corrélation entre la densité numérique en plans d'eau (hors mares et marais) et le ratio de débit (étiage et module) montre cependant (pour les masses d'eau cours d'eau dont la distance de cook est inférieure à 0,01) que :

- "p value" = 4,143e-13
- "R² ajusté" = 0,05818

Ce qui indique que la significativité de ce lien de corrélation est très faible.
