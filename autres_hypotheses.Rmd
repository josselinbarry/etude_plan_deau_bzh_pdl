...
Après une rapide présentation du profil général des surfaces en eau, ce document proposera de répondre à différentes hypothèses :
...
## Profil général des surfaces en eau 

### Zones humides, sur cours, sur nappe, sur source ...

Voici la répartition des surfaces en eau selon leur rapport au réseau hydrographique : 
...
### Le taux d'interception du linéaire hydrographique du bassin versant des masses d'eau
...
- La densité numérique la plus forte (> 3,2 pe/km²) se retrouve avec la classe lithologique Argile [**La classe lithologique « Argiles » ne représente de 9% de la surface totale de la zone d’étude. Est-ce que l’échantillon est suffisant pour conclure ?**]. Cette classe lithologique est en effet adaptée par son imperméabilité à l'implantation de plans d'eau. [Les soutiens de débit à l'étiage y sont moins importants, soulignant le besoin de stocker l'eau.]-> **Le substrat argileux est en effet réputé imperméable, ce qui laisse supposer qu’il y a globalement peu d’infiltration et donc un soutien d’étiage par la nappe plutôt réduit. Néanmoins, en toute rigueur nous devrions vérifier que les débits d’étiage des cours d’eau y sont réellement inférieurs ou plus contrastés. La carte qui vient juste après, et qui présente les QMNA5 rapportés au module, semble d’ailleurs contredire cette hypothèse, notamment en Sarthe. **
...
Nous avons calculé, à l'échlle du bassin versant des masses d'eau, les densités en plans d'eau en fonction de 4 principales classes de ratio de débit : 
...
Enfin il nous a paru intéressant de regarder les densités numériques et surfaciques en plans d'eau (hors mares et marais) du bassin-versant des masses d'eau selon la sévérité de leurs étiages : 
...
Ces résultats montrent que le ratio de débit influe la répartition géographique des surfaces élémentaires de plans d'eau.

Les densités numériques et surfaciques sont directement corrélées avec les classes de "sévérité des étiages" : plus le débit d'étiage est faible en proportion du débit de module et plus les densités (numériques et surfaciques) seront importantes.
...
Ce résultat s'explique par un besoin accru en stockage d'eau dans les territoires où les régimes d'étiage seront les plus sévères par rapport au module.
...
Il est intéressant de noter que la surface médiane d'un plan d'eau répond également à cette logique de besoin de stockage de l'eau en fonction de la "sévérité des étiages".
...
Cela se confirme en étudiant la taille des plans d'eau selon la "sévérité des étiages" : 
...
La densité de plans d’eau est 2 à 3 fois supérieure dans les secteurs présentant les contrastes hydrologiques saisonniers les plus forts, c’est-à-dire comportant un QMNA5 inférieur au 40ème du module. Ce résultat est conforté par le fait que les échantillons des 4 classes de contrastes de débits sont comparables en surface. 
On relève également des surfaces médianes 30 à 40% plus importantes dans les portions de territoire où la sévérité de l'étiage est la plus marquée, en comparaison des territoires où cette sévérité est moindre.
Cela peut s'expliquer par un besoin accru de stocker l'eau en période d'étiage.
A noter les densités de moindres valeurs en raison du plus faible nombre de plans d'eau retenus pour l'analyse.
...
Voici la densité numérique de plans d'eau des communes en fonction de leur proportion de surface en maraichage :
